...
class PaintingOrderDetailsScreen extends StatelessWidget {
  const PaintingOrderDetailsScreen({super.key});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Image.asset(AppImages.person4, height: 50.0, width: 40.0,),
                    ],
                  ),
                  Text(
                    'Mohsen Salah', //craft man info
                    style: interRegular(
                        fontStyle: FontStyle.normal, color: AppColors.black),
                  ),
                  Row(
