...
class ElectricityOrderDetailsScreen extends StatelessWidget {
  const ElectricityOrderDetailsScreen({super.key});
          ...
          child: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.only(
                  top: 70.0, right: 20.0, left: 20.0, bottom: 11.0),
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        AppStrings.electricalInstallation,
                        style: interBold(
                          fontSize: 18.0,
                          fontStyle: FontStyle.normal,
                          color: AppColors.black,
                      ...
                      const Spacer(),
                      Image.asset(AppImages.person2,height: 50.0, width: 40.0,),
                    ],
                  ),
                  Text(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          // add another craft man method
                        },
                        child: const Text(
                          AppStrings.addAnotherCraft,
                          style: TextStyle(
