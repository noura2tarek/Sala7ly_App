...
class ElectricalAppliancesOrderScreen extends StatelessWidget {
  const ElectricalAppliancesOrderScreen({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.center,
                    child: Text(
                      AppStrings.electricalAppAddress,
                      style: interRegular(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        AppStrings.washingMachineRepairment,
                        style: interBold(
                          fontSize: 17.0,
                          fontStyle: FontStyle.normal,
                          color: AppColors.black,
