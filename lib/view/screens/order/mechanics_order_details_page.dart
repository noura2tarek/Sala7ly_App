...
class MechanicsOrderDetailsScreen extends StatelessWidget {
  const MechanicsOrderDetailsScreen({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Mostafa EL-sayed', //craft man info
                    style: interRegular(
                        fontStyle: FontStyle.normal, color: AppColors.black),
                  ),
                  Row(
