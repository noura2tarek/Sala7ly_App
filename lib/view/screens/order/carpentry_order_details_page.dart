...
class CarpentryOrderDetailsScreen extends StatelessWidget {
  const CarpentryOrderDetailsScreen({super.key});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Image.asset(AppImages.person3,height: 50.0, width: 40.0,),
                    ],
                  ),
                  Text(
                    'Mostafa Alaa', //craft man info
                    style: interRegular(
                        fontStyle: FontStyle.normal, color: AppColors.black),
                  ),
                  Row(
